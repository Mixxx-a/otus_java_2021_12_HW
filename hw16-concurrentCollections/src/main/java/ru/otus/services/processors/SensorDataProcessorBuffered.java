...
public class SensorDataProcessorBuffered implements SensorDataProcessor {
    ...
    public void flush() {
        try {
            ...
            List<SensorData> sortedBufferedData = bufferedData.stream()
                    .sorted(Comparator.comparing(SensorData::getMeasurementTime)).toList();
            if (!bufferedData.isEmpty()) {
                writer.writeBufferedData(sortedBufferedData);
            }
        } catch (Exception e) {
