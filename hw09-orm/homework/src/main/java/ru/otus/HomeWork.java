...
import ru.otus.jdbc.mapper.implementation.DataTemplateJdbc;
...
// Дополнительная проверка на update
        ...
        Manager managerFirstUpdated = dbServiceManager.saveManager(new Manager(1L, "ManagerFirstUpdated", "param1"));
        Manager managerFirstUpdatedSelected = dbServiceManager.getManager(managerFirstUpdated.getNo())
                .orElseThrow(() -> new RuntimeException("Manager not found, id:" + managerFirstUpdated.getNo()));
        log.info("managerFirstUpdatedSelected:{}", managerFirstUpdatedSelected);
    }
